...
os.environ['TORCH_HOME']= fr'{ROOT}/pretrain/'
...
def setup_training_loop_kwargs(
    ...
    data2      = None, # Training dataset (required): <path>
    ...
    args.loss_kwargs = dnnlib.EasyDict(class_name='training.loss2.StyleGAN2Loss', r1_gamma=spec.gamma)
    # args.loss_kwargs = dnnlib.EasyDict(class_name='training.simloss.StyleGAN2Loss', r1_gamma=spec.gamma)
...
@click.option('--data2', help='Training data (directory or zip)', metavar='PATH', required=True)
