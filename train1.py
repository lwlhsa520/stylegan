...
def init_dataset_kwargs(data, bbox_dim):
    try:
        dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset.ImageFolderDataset', path=data, bbox_dim=bbox_dim, use_labels=True, max_size=None, xflip=False, aug=True)
...
def main(**kwargs):
    ...
    c.test_set_kwargs, _ = init_dataset_kwargs(data=opts.data2, bbox_dim=opts.bbox_dim)
    ...
    c.D_kwargs = dnnlib.EasyDict(
        class_name='training.rcnn_discriminator.CombineDiscriminator256',
        diffaug=True,
        num_classes=2,
    )
