...
def subprocess_fn(rank, args, temp_dir):
    ...
    if rank == 0 and args.verbose:
        ...
        bbox = torch.empty([1, G.bbox_dim, 4], device=device)
    ...
    for metric in args.metrics:
        ...
        result_dict = metric_main.calc_metric(metric=metric, G=G, dataset_kwargs=args.dataset_kwargs, dataset1_kwargs=args.dataset_kwargs,
...
def calc_metrics(ctx, network_pkl, metrics, data, data1, mirror, gpus, verbose):
    ...
    args.dataset1_kwargs = dnnlib.EasyDict(class_name='training.dataset.ImageFolderDataset', path=data1)
