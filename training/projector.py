...
import timm
from training.blocks import FeatureFusionBlock
...
def _make_projector(im_res, cout, proj_type, expand=False):
    ...
    # model = timm.create_model('tf_efficientnet_lite0', checkpoint_path='/home/lwlhsa/.cache/torch/hub/checkpoints/tf_efficientnet_lite0-0aa007d2.pth')
